...
# 3. قسم البرومو (الواجهة التعريفية)
st.markdown("""
...
# 4. شريط الأنباء العاجلة (News Bar)
analysis = habbi_brain.analyze_habbi_golden()
...
# 6. شبكة الإحصائيات (3x2 Grid) مع تفعيل Freshness Rule
if habbi_brain.is_fresh(analysis['time']):
